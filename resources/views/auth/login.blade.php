...
<head>
    ...
    <title>Login &mdash; FEB UNDIP </title>
    ...
    <link rel="shortcut icon" href="../assets/img/logoundip.png" type="image/x-icon">
</head>
        ...
        <section class="section">
            <div class="d-flex flex-wrap align-items-stretch">
                <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
                    <div class="p-4 m-3">
                        <img src="../assets/img/logoundip.png" alt="logo" width="80" class="shadow-light rounded-circle mb-5 mt-2">
                        <h5 class="text-dark font-weight-normal">Aplikasi <span class="font-weight-bold">Inventaris Barang Kampus</span></h5>
                ...
                <div class="col-lg-8 col-12 order-lg-2 order-1 min-vh-100 background-walk-y position-relative overlay-gradient-bottom" data-background="../assets/img/unsplash/dekanat1.jpg">
                    <div class="absolute-bottom-left index-2">
                        <div class="text-light p-5 pb-2">
                            ...
                            Photo by <a class="text-light bb" target="_blank" href="https://www.instagram.com/kknmum.umy005/">DEKANAT FEB UNDIP</a>
                        </div>
                    </div>
                </div>
            </div>
