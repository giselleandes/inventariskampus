...
for(var i = 0; i < chats.length; i++) {
  ...
  $.chatCtrl('#mychatbox', {
    ...
    picture: (chats[i].position == 'left' ? '../assets/img/avatar/avatar-1.png' : '../assets/img/avatar/avatar1.png'),
...
$("#chat-form").submit(function() {
  ...
  if(me.find('input').val().trim().length > 0) {
    $.chatCtrl('#mychatbox', {
      ...
      picture: '../assets/img/avatar/avatar1.png',
    });
    me.find('input').val('');
  }
  return false;
...
for(var i = 0; i < chats.length; i++) {
  ...
  $.chatCtrl('#mychatbox2', {
    text: (chats[i].text != undefined ? chats[i].text : ''),
    picture: (chats[i].position == 'left' ? '../assets/img/avatar/avatar-5.png' : '../assets/img/avatar/avatar1.png'),
    position: 'chat-'+chats[i].position,
    type: type
  });
}
